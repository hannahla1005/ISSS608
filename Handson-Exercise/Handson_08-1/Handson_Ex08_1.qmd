...
### **22.2.1 Geospatial Data Wrangling**
...
### **22.2.2 Data Import and Preparation**
...
### **23.3.1 It all started with an interactive point symbol map**

```{r}
tm_shape(sgpools_sf)+
tm_bubbles(col = "purple",
           size = 1,
           border.col = "black",
           border.lwd = 1)
```

## **23.4 Lets make it proportional**
...
## **23.5 Lets give it a different colour**
...
### **23.7.2 Geospatial data wrangling**
