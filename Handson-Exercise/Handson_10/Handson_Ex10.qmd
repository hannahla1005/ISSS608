...
reactablefmtr, gt, gtExtras, tidyverse,ggplot)
```
...
ggplot(product, aes(Product, current)) + 
  ...
  geom_col(aes(Product, target * 0.75),
           fill="#5B00AE", width=0.85) +
  geom_col(aes(Product, target * 0.5),
           fill="#BE77FF", width=0.85) +
...
plot sparklines by using ggplot2
...
The code chunk below is used to compute the 25 and 75 quantile.
...
To create static information dashboard by using [gt](https://gt.rstudio.com/) and [gtExtras](https://jthomasmock.github.io/gtExtras/index.html) packages
